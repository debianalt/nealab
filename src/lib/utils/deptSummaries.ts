...
const ITAPUA_SUMMARIES: Record<string, () => Promise<any>> = {
	...
	territorial_types:      () => import('$lib/data/itapua_py_sat_territorial_types_summary.json'),
...
const ALTO_PARANA_SUMMARIES: Record<string, () => Promise<any>> = {
	...
	territorial_types:      () => import('$lib/data/alto_parana_py_sat_territorial_types_summary.json'),
...
const PARANA_BR_SUMMARIES: Record<string, () => Promise<any>> = {
	...
	territorial_types       : () => import('$lib/data/parana_br_sat_territorial_types_summary.json'),
...
const SANTA_CATARINA_BR_SUMMARIES: Record<string, () => Promise<any>> = {
	...
	territorial_types       : () => import('$lib/data/santa_catarina_br_sat_territorial_types_summary.json'),
...
const RIO_GRANDE_SUL_BR_SUMMARIES: Record<string, () => Promise<any>> = {
	...
	territorial_types       : () => import('$lib/data/rio_grande_sul_br_sat_territorial_types_summary.json'),
