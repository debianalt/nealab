...
const dict: Record<string, Record<Locale, string>> = {
	...
	'warn.censusCrossCountry': { es: '⚠ Estás comparando radios de distintos países. Los datos censales (INDEC AR · DGEEC PY · IBGE BR) usan definiciones e institutos distintos: solo son comparables al interior de cada país.', en: '⚠ You are comparing tracts from different countries. Census data (INDEC AR · DGEEC PY · IBGE BR) uses different definitions and institutes — it is only comparable within each country.', gn: "⚠ Eñembojoja hína radio ambue tetãgui. Censo mba'ekuaa (INDEC AR · DGEEC PY · IBGE BR) ndaha'éi peteĩcha: ojejojakuaa peteĩteĩ tetã ryepýpe año.", pt: '⚠ Você está comparando setores de países diferentes. Os dados censitários (INDEC AR · DGEEC PY · IBGE BR) usam definições e institutos distintos — só são comparáveis dentro de cada país.' },
