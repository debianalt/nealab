...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.poly_report': { es: '📩 Solicitar informe técnico firmado →', en: '📩 Request signed technical report →', gn: '📩 Solicitá informe →', pt: '📩 Solicitar relatório técnico assinado →' },
	...
	'eudr.check.req_intro': { es: 'El informe firmado se emite manualmente vía el canal STAN-CONICET (no es self-service). Completá los datos y se prepara un mail prearmado a nealab@spatia.ar con el resumen del análisis. Te volvemos en días hábiles.', en: 'The signed report is issued manually through the STAN-CONICET channel (not self-service). Fill in your details — a prefilled email to nealab@spatia.ar will open with the analysis summary. We reply within business days.', gn: 'Informe firmado oñe-emite humano-rupive.', pt: 'O relatório assinado é emitido manualmente via canal STAN-CONICET (não é self-service). Preencha os dados — um e-mail pré-formatado para nealab@spatia.ar será aberto com o resumo da análise. Respondemos em dias úteis.' },
	...
	'eudr.check.req_note': { es: 'Al enviar, se descarga el GeoJSON de tu polígono — adjuntalo al mail antes de mandarlo. El equipo CONICET/UNaM revisa la solicitud y emite el informe firmado offline.', en: 'When submitting, the polygon GeoJSON is downloaded — attach it to the email before sending. The CONICET/UNaM team reviews the request and issues the signed report offline.', gn: 'GeoJSON ojedescarga-jepi.', pt: 'Ao enviar, o GeoJSON do polígono é baixado — anexe-o ao e-mail. A equipe CONICET/UNaM revisa e emite o relatório assinado offline.' },
