...
const dict: Record<string, Record<Locale, string>> = {
	...
	'trade.eudr.analysis_title': { es: 'EUDR · Riesgo de deforestación (norte argentino + Paraguay + sur de Brasil)', en: 'EUDR · Deforestation risk (northern Argentina + Paraguay + southern Brazil)', gn: 'EUDR · Deforestación (Argentina norte + Paraguay + Brasil sur)', pt: 'EUDR · Risco de desmatamento (norte argentino + Paraguai + sul do Brasil)' },
	...
	'eudr.check.plant_managed_confirmed': { es: 'Plantación forestal ya presente en 2020 ({pct}%). La pérdida post-2020 es un ciclo de cosecha — conforme con EUDR, NO es deforestación de bosque nativo.', en: 'Forestry plantation already present in 2020 ({pct}%). Post-2020 loss is a harvest cycle — EUDR-compliant, NOT native-forest deforestation.', gn: 'Plantación forestal oĩma 2020-pe ({pct}%). Pérdida post-2020 ha\'e cosecha — EUDR-pe conforme, ndaha\'éi deforestación ka\'aguy nativo.', pt: 'Plantação florestal já presente em 2020 ({pct}%). A perda pós-2020 é um ciclo de colheita — conforme com a EUDR, NÃO é desmatamento de floresta nativa.' },
	'eudr.check.plant_conversion': { es: '⚠️ Conversión post-2020: cobertura nativa en 2020, plantación hoy. La pérdida puede ser deforestación de bosque nativo NO conforme con EUDR.', en: '⚠️ Post-2020 conversion: native cover in 2020, plantation today. The loss may be native-forest deforestation NOT compliant with the EUDR.', gn: '⚠️ Conversión post-2020: cobertura nativa 2020-pe, plantación ko\'ágã. Pérdida ikatu ha\'e deforestación ka\'aguy nativo, ndaha\'éi EUDR-pe conforme.', pt: '⚠️ Conversão pós-2020: cobertura nativa em 2020, plantação hoje. A perda pode ser desmatamento de floresta nativa NÃO conforme com a EUDR.' },
	'eudr.check.plant_native_loss': { es: 'Pérdida sobre cobertura nativa (bosque nativo en 2020). Posible deforestación post-2020.', en: 'Loss over native cover (native forest in 2020). Possible post-2020 deforestation.', gn: 'Pérdida cobertura nativa ári (ka\'aguy nativo 2020-pe). Ikatu deforestación post-2020.', pt: 'Perda sobre cobertura nativa (floresta nativa em 2020). Possível desmatamento pós-2020.' },
	'eudr.check.plant_nodata': { es: 'Sin dato de plantación para esta zona (cobertura MapBiomas: por ahora solo Argentina).', en: 'No plantation data for this area (MapBiomas coverage: Argentina only for now).', gn: "Ndaipóri dato plantación ko rendápe (MapBiomas: Argentina añónte ko'ágã).", pt: 'Sem dado de plantação para esta área (cobertura MapBiomas: por ora apenas Argentina).' },
	'eudr.check.plant_nodata_loss': { es: '⚠️ Sin dato de plantación en esta zona (Paraguay/Brasil). MapBiomas no clasifica silvicultura acá, así que esta pérdida no pudo distinguirse entre cosecha de plantación (conforme) y deforestación de bosque nativo. Si el lote es una forestación, podría ser un falso positivo — verificar en terreno o con catastro oficial.', en: '⚠️ No plantation data for this area (Paraguay/Brazil). MapBiomas does not classify forestry plantations here, so this loss could not be distinguished between a plantation harvest (compliant) and native-forest deforestation. If the plot is a plantation, it may be a false positive — verify on the ground or with the official cadastre.', gn: '⚠️ Ndaipóri dato plantación ko rendápe (Paraguay/Brasil). MapBiomas nomboja\'éi silvicultura ko\'ápe, upévare ko pérdida ndaikatúi oñembojoja cosecha plantación (conforme) ha deforestación ka\'aguy nativo apytépe. Lote ha\'éramo forestación, ikatu falso positivo — emoañete terreno térã catastro oficial-pe.', pt: '⚠️ Sem dado de plantação para esta área (Paraguai/Brasil). O MapBiomas não classifica silvicultura aqui, então esta perda não pôde ser distinguida entre colheita de plantação (conforme) e desmatamento de floresta nativa. Se o lote for uma plantação, pode ser um falso positivo — verifique em campo ou com o cadastro oficial.' },
	'eudr.check.poly_plant_split': { es: 'De los hexágonos con pérdida post-2020: {harvest} cosecha de plantación ya presente en 2020 (conforme), {conversion} conversión de nativo a plantación post-2020 (NO conforme) y {native} pérdida de bosque nativo.', en: 'Of the cells with post-2020 loss: {harvest} harvest of plantation already present in 2020 (compliant), {conversion} native-to-plantation conversion post-2020 (NON-compliant) and {native} native-forest loss.', gn: 'Umi hexágono pérdida post-2020: {harvest} cosecha plantación oĩmava\'ekue 2020-pe (conforme), {conversion} conversión nativo→plantación post-2020 (ndaha\'éi conforme) ha {native} pérdida ka\'aguy nativo.', pt: 'Das células com perda pós-2020: {harvest} colheita de plantação já presente em 2020 (conforme), {conversion} conversão de nativo para plantação pós-2020 (NÃO conforme) e {native} perda de floresta nativa.' },
