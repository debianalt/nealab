...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.poly_plant_split': { es: 'De los hexágonos con pérdida post-2020: {plant} en plantación forestal (posible ciclo de cosecha, no deforestación) y {native} en cobertura no-plantación (posible deforestación de bosque nativo).', en: 'Of the cells with post-2020 loss: {plant} on forestry plantation (possible harvest cycle, not deforestation) and {native} on non-plantation cover (possible native-forest deforestation).', gn: 'Umi hexágono pérdida post-2020 reheve: {plant} plantación forestal-pe (ikatu cosecha, ndaha\'éi deforestación) ha {native} cobertura no-plantación-pe (ikatu deforestación ka\'aguy nativo).', pt: 'Das células com perda pós-2020: {plant} em plantação florestal (possível ciclo de colheita, não desmatamento) e {native} em cobertura não-plantação (possível desmatamento de floresta nativa).' },
