...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.poly_report': { es: '📩 Solicitar informe técnico completo →', en: '📩 Request full technical report →', gn: '📩 Solicitá informe técnico →', pt: '📩 Solicitar relatório técnico completo →' },
