...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.plant_nodata': { es: 'Sin dato de plantación para esta zona. La distinción plantación / bosque nativo (MapBiomas) está disponible por ahora solo en Misiones y Corrientes (Argentina).', en: 'No plantation data for this area. The plantation / native-forest distinction (MapBiomas) is available for now only in Misiones and Corrientes (Argentina).', gn: "Ndaipóri dato plantación ko rendápe. Plantación / ka'aguy nativo distinción oĩ Misiones ha Corrientes-pe añónte ko'ágã.", pt: 'Sem dado de plantação para esta área. A distinção plantação / floresta nativa (MapBiomas) está disponível por ora apenas em Misiones e Corrientes (Argentina).' },
	'eudr.check.plant_nodata_loss': { es: '⚠️ Sin dato de plantación para esta zona — la cobertura plantación/nativo (MapBiomas) está por ahora solo en Misiones y Corrientes (Argentina). Acá NO se pudo distinguir si la pérdida es sobre plantación (posible cosecha) o sobre bosque nativo. Si el lote es una forestación, podría ser un falso positivo — verificar en terreno o con catastro oficial.', en: '⚠️ No plantation data for this area — plantation/native cover (MapBiomas) is for now only in Misiones and Corrientes (Argentina). Here the loss could NOT be distinguished between plantation (possible harvest) and native forest. If the plot is a plantation, it may be a false positive — verify on the ground or with the official cadastre.', gn: '⚠️ Ndaipóri dato plantación — cobertura oĩ Misiones ha Corrientes-pe añónte. Ko\'ápe ndaikatúi oñembojoja plantación (ikatu cosecha) ha ka\'aguy nativo apytépe. Lote ha\'éramo forestación, ikatu falso positivo — emoañete terreno térã catastro-pe.', pt: '⚠️ Sem dado de plantação para esta área — a cobertura plantação/nativo (MapBiomas) está por ora apenas em Misiones e Corrientes (Argentina). Aqui a perda NÃO pôde ser distinguida entre plantação (possível colheita) e floresta nativa. Se o lote for uma plantação, pode ser um falso positivo — verifique em campo ou com o cadastro oficial.' },
	'eudr.check.poly_plant_split': { es: 'Cobertura en 2020 de las celdas con pérdida arbórea: {harvest} sobre plantación forestal, {native} sobre bosque nativo, {other} sobre otra cobertura (agro/pasturas/mosaico); {conversion} eran nativo en 2020 y hoy figuran como plantación (posible conversión, a verificar). Señal indicativa, no determina causa ni cumplimiento.', en: 'Cover in 2020 of the cells with tree-cover loss: {harvest} over forestry plantation, {native} over native forest, {other} over other cover (cropland/pasture/mosaic); {conversion} were native in 2020 and are plantation today (possible conversion, to verify). Indicative — does not determine cause or compliance.', gn: 'Cobertura 2020-pe umi celda pérdida reheve: {harvest} plantación forestal ári, {native} ka\'aguy nativo ári, {other} ambue cobertura ári; {conversion} nativo 2020-pe ha ko\'ágã plantación (ikatu conversión). Indicativo añónte.', pt: 'Cobertura em 2020 das células com perda arbórea: {harvest} sobre plantação florestal, {native} sobre floresta nativa, {other} sobre outra cobertura (agro/pasto/mosaico); {conversion} eram nativo em 2020 e hoje são plantação (possível conversão, a verificar). Indicativa — não determina causa nem conformidade.' },
