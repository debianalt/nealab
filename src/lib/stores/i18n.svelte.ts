...
const dict: Record<string, Record<Locale, string>> = {
	...
	'hex.goalpostNote': { es: 'Valores /100: escala fija regional, idéntica en todos los territorios comparables — 100 es el techo del rango de referencia (NEA + región transfronteriza), no el máximo del territorio. Solo la flor de arriba compara contra el promedio local.', en: 'Values /100: fixed regional scale, identical across all comparable territories — 100 is the ceiling of the reference range (NEA + trans-boundary region), not the territory maximum. Only the flower above compares against the local average.', gn: 'Papapy /100: escala fija regional, peteĩchagua opa tetãme — 100 ndaha\'éi tetã máximo. Yvoty año ombojoja promedio local ndive.', pt: 'Valores /100: escala fixa regional, idêntica em todos os territórios comparáveis — 100 é o teto do intervalo de referência (NEA + região transfronteiriça), não o máximo do território. Apenas a flor acima compara contra a média local.' },
