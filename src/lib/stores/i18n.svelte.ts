...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.poly_draw_hint': { es: 'Click en el mapa para agregar vértices. Doble-click para cerrar el polígono y analizar.', en: 'Click on the map to add vertices. Double-click to close the polygon and analyze.', gn: 'Click vértices-rã, doble-click oñembotypa.', pt: 'Clique no mapa para adicionar vértices. Duplo-clique para fechar o polígono e analisar.' },
	'eudr.check.poly_draw_cancel': { es: 'Cancelar dibujo', en: 'Cancel drawing', gn: 'Ejoko', pt: 'Cancelar desenho' },
