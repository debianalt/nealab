...
const dict: Record<string, Record<Locale, string>> = {
	...
	'eudr.check.poly_report': { es: '📄 Generar informe técnico (imprimir / PDF)', en: '📄 Generate technical report (print / PDF)', gn: '📄 Informe técnico', pt: '📄 Gerar relatório técnico (imprimir / PDF)' },
