...
export const ANALYSIS_CONTENT: Record<string, LocalizedMethodologyContent> = {
	...
	eudr: {
		howToRead: {
			es: 'El mapa muestra el riesgo de deforestación post-2020 por hexágono (H3 res-9, ~0,1 km²). Score alto (rojo) = mayor pérdida forestal o actividad de fuego después del cutoff EUDR (31/12/2020). Cobertura: 10 provincias del NOA y NEA argentino.',
			en: 'The map shows post-2020 deforestation risk per hexagon (H3 res-9, ~0,1 km²). High score (red) = greater forest loss or fire activity after the EUDR cut-off date (31/12/2020). Coverage: 10 provinces of Northwest and Northeast Argentina.',
			gn: "Mapa ohechauka riesgo deforestación post-2020 hexágono ndive (H3 res-9, ~0,1 km²). Score yvate (pyta) = yvate pérdida forestal o tata post EUDR cutoff (31/12/2020). Cobertura: 10 provincias NOA ha NEA.",
			pt: 'O mapa mostra o risco de desmatamento pós-2020 por hexágono (H3 res-9, ~0,1 km²). Score alto (vermelho) = maior perda florestal ou atividade de fogo após o cutoff EUDR (31/12/2020). Cobertura: 10 províncias do NOA e NEA argentino.',
		},
		implications: {
