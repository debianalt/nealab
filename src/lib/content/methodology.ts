...
export const ANALYSIS_CONTENT: Record<string, LocalizedMethodologyContent> = {
	...
	land_use: {
		howToRead: {
			es: 'El mapa muestra la composición de cobertura del suelo de cada hexágono. El color representa la fracción arbórea (verde más intenso = mayor cobertura de árboles). El panel de detalle muestra las 9 clases de Dynamic World: árboles, cultivos, pasturas, arbustos, construido, agua, vegetación inundada, suelo desnudo y nieve/hielo. Las fracciones son probabilidades medias por hexágono y suman ≈ 1.',
			en: 'The map shows the land-cover composition of each hexagon. Colour encodes the tree fraction (greener = more tree cover). The detail panel shows the 9 Dynamic World classes: trees, crops, grass, shrub, built, water, flooded vegetation, bare soil and snow/ice. Fractions are mean per-hexagon probabilities and sum to ≈ 1.',
