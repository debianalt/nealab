...
export const ANALYSIS_CONTENT: Record<string, LocalizedMethodologyContent> = {
	...
	eudr: {
		...
		method: {
			es: `Score compuesto 0-100: 70% pérdida forestal post-2020 (Hansen GFC v1.12, Landsat, remuestreado a 100 m) + 20% área quemada post-2020 (MODIS MCD64A1, 500m) + 10% pérdida de cobertura previa. Cutoff EUDR: 31/12/2020. Resolución espacial: H3 resolución 9 (~0,1 km²); el dato satelital subyacente es de 100 m, que es el piso de precisión efectivo. Cobertura: 10 provincias del NOA y NEA argentino (Salta, Jujuy, Tucumán, Catamarca, Sgo. del Estero, Formosa, Chaco, Corrientes, Misiones, Entre Ríos) + 10 departamentos del Paraguay oriental y Chaco (Itapúa, Alto Paraná, Canindeyú, Caazapá, Misiones, Ñeembucú, Presidente Hayes, Boquerón, Alto Paraguay, Central) + 3 estados del sur de Brasil (Paraná, Santa Catarina, Rio Grande do Sul).`,
			en: `Composite score 0–100: 70% post-2020 forest loss (Hansen GFC v1.12, Landsat, resampled to 100 m) + 20% post-2020 burned area (MODIS MCD64A1, 500m) + 10% prior cover loss. EUDR cut-off: 31/12/2020. Spatial resolution: H3 resolution 9 (~0.1 km²); the underlying satellite data is 100 m, which is the effective precision floor. Coverage: 10 provinces of Northwest and Northeast Argentina (Salta, Jujuy, Tucumán, Catamarca, Santiago del Estero, Formosa, Chaco, Corrientes, Misiones, Entre Ríos) + 10 departments of eastern and Chaco Paraguay (Itapúa, Alto Paraná, Canindeyú, Caazapá, Misiones, Ñeembucú, Presidente Hayes, Boquerón, Alto Paraguay, Central) + 3 southern Brazilian states (Paraná, Santa Catarina, Rio Grande do Sul).`,
		},
	},
	accessibility: {
		howToRead: {
