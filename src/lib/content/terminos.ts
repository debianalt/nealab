...
export const TERMINOS: Record<Locale, TerminosContent> = {
	...
	gn: {
		...
		s8Title: '8. Propiedad intelectual',
		s8P1: 'Datos nealab-pe oĩva oú fuentes públicas-gui — INDEC, IGN, JRC/Comisión Europea, Hansen GFC, MODIS, MapBiomas ha OpenStreetMap — ha ojeporu licencias originales reheve. Pipeline, código ha visualizaciones Raimundo Elias Gomez ojapóva ha ikatu oñemombe\'u <a href="/gn/servicios">spatia.ar/gn/servicios</a>-pe.',
