...
<p>Esa vegetación nativa es, casi enteramente, bosque. MapBiomas la separa en formación forestal y formación sabánica, y el <strong>97,2 %</strong> de las 539.741 hectáreas perdidas sobre cobertura nativa corresponde a la primera: 257.310 ha en Chaco, 165.997 en Formosa, 91.244 en Misiones y 9.813 en Corrientes. La formación forestal abarca tanto la selva paranaense de Misiones como el bosque seco chaqueño. En Misiones la proporción es del 100 %, porque la provincia no registra formación sabánica.</p>`,
...
<p>That native vegetation is almost entirely forest. MapBiomas separates it into forest formation and savanna formation, and <strong>97.2%</strong> of the 539,741 hectares lost over native cover belongs to the former: 257,310 ha in Chaco, 165,997 in Formosa, 91,244 in Misiones and 9,813 in Corrientes. Forest formation covers both the Paraná rainforest of Misiones and the dry Chaco woodland. In Misiones the share is 100%, as the province records no savanna formation.</p>`
	},
