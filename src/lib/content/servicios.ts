...
export const SERVICIOS: Record<Locale, ServiciosContent> = {
	es: {
		...
		fuentesP1: 'nealab integra datos de fuentes públicas, entre ellas: INDEC (Censo Nacional de Población, Hogares y Viviendas 2022), IGN, Dirección General de Catastro de Misiones, JRC Global Surface Water, Hansen Global Forest Change, MODIS, MapBiomas (Argentina y Paraguay), CHIRPS (Climate Hazards Group InfraRed Precipitation with Station data), ERA5 (reanálisis climático del Centro Europeo de Predicción Meteorológica a Medio Plazo — ECMWF, 5.ª versión), VIIRS (Visible Infrared Imaging Radiometer Suite, sensor NOAA/NASA), GHSL (Global Human Settlement Layer, Centro Común de Investigación de la Unión Europea), SoilGrids (ISRIC — International Soil Reference and Information Centre), misiones Sentinel de la Agencia Espacial Europea (ESA) / programa Copernicus, Global Building Atlas (GBA; Zhu et al., 2025, Earth System Science Data — ESSD), Overture Maps Foundation, OpenStreetMap, Meta / World Resources Institute (WRI) Canopy Height, GEDI L4B (Global Ecosystem Dynamics Investigation — NASA), ESA CCI Biomass (Climate Change Initiative de la ESA), Global Forest Watch (GFW), conjunto PM2.5 de la Universidad de Dalhousie (ACAG — Atmospheric Composition Analysis Group), Oxford MAP (Malaria Atlas Project), Dirección General de Estadística, Encuestas y Censos de Paraguay (DGEEC) e Instituto Brasileiro de Geografia e Estatística (IBGE), entre otras. El procesamiento de la plataforma pública se realizó sobre Google Earth Engine como plataforma de cómputo, en su nivel de investigación (<strong>Partner Tier</strong>, uso no comercial).',
	...
	pt: {
		...
		fuentesP1: 'nealab integra dados de fontes públicas, entre elas: INDEC (Censo Nacional de População, Domicílios e Moradias 2022), IGN, Diretoria-Geral de Cadastro de Misiones, JRC Global Surface Water, Hansen Global Forest Change, MODIS, MapBiomas (Argentina e Paraguai), CHIRPS (Climate Hazards Group InfraRed Precipitation with Station data), ERA5 (reanálise climática do Centro Europeu de Previsão de Tempo de Médio Prazo — ECMWF, 5.ª geração), VIIRS (Visible Infrared Imaging Radiometer Suite, sensor NOAA/NASA), GHSL (Global Human Settlement Layer, Centro Conjunto de Pesquisa da União Europeia), SoilGrids (ISRIC — International Soil Reference and Information Centre), missões Sentinel da Agência Espacial Europeia (ESA) / programa Copernicus, Global Building Atlas (GBA; Zhu et al., 2025, Earth System Science Data — ESSD), Overture Maps Foundation, OpenStreetMap, Meta / World Resources Institute (WRI) Canopy Height, GEDI L4B (Global Ecosystem Dynamics Investigation — NASA), ESA CCI Biomass (Iniciativa de Mudança Climática da ESA), Global Forest Watch (GFW), conjunto de dados PM2,5 da Universidade de Dalhousie (ACAG — Atmospheric Composition Analysis Group), Oxford MAP (Malaria Atlas Project), Dirección General de Estadística, Encuestas y Censos de Paraguai (DGEEC) e Instituto Brasileiro de Geografia e Estatística (IBGE), entre outras. O processamento da plataforma pública foi realizado no Google Earth Engine como plataforma de computação, em seu nível de pesquisa (<strong>Partner Tier</strong>, uso não comercial).',
	...
	gn: {
		...
		fuentesP1: 'nealab oñemboikuaa mba\'ekuaa fuentes públicas-gui, oĩva: INDEC (Censo Nacional 2022), IGN, Catastro Misiones, JRC Global Surface Water, Hansen Global Forest Change, MODIS, MapBiomas, CHIRPS, ERA5, VIIRS, GHSL, SoilGrids, Sentinel/ESA/Copernicus, Global Building Atlas, Overture Maps, OpenStreetMap, Meta/WRI Canopy Height, GEDI L4B, ESA CCI Biomass, Global Forest Watch, PM2.5 Dalhousie/ACAG, Oxford MAP, DGEEC Paraguay ha IBGE Brasil, ambuéva. Plataforma pública procesamiento oñemboguapy Google Earth Engine-pe, nivel investigación-pe (<strong>Partner Tier</strong>, uso no comercial).',
		contactoTitle: 'Contacto',
		contactoContent: '<strong>Raimundo Elias Gomez</strong><br />Investigador CONICET · Facultad de Humanidades y Ciencias Sociales, Universidad Nacional de Misiones (Argentina)<br /><a href="mailto:nealab@spatia.ar">nealab@spatia.ar</a>',
