...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		...
		sat_climate_vulnerability: '?v=8',
		sat_carbon_stock: '?v=14',
		sat_pm25_drivers: '?v=11',
		sat_deforestation_dynamics: '?v=11',
		sat_productive_activity: '?v=15',
		sat_land_use: '?v=2',
		sat_soil_water: '?v=7',
		overture_scores: '?v=32',
...
export const ANALYSIS_REGISTRY: AnalysisConfig[] = [
	// ── Vivir ──
	{
		...
		coverage: { chaco: 'unavailable', formosa: 'unavailable', parana_br: 'unavailable', santa_catarina_br: 'unavailable', rio_grande_sul_br: 'unavailable'},
		status: 'available',
	...
	// ── Soil Water ──
	{
		...
		coverage: { alto_parana_py: 'available', itapua_py: 'available', corrientes: 'available', chaco: 'available', formosa: 'available', parana_br: 'unavailable', santa_catarina_br: 'unavailable', rio_grande_sul_br: 'unavailable'},
		comparable: true,
		status: 'available',
		spatialUnit: 'hexagon',
	},
	// ── Climate Vulnerability ──
	{
		...
		coverage: { alto_parana_py: 'available', itapua_py: 'available', corrientes: 'available', chaco: 'available', formosa: 'unavailable', parana_br: 'unavailable', santa_catarina_br: 'unavailable', rio_grande_sul_br: 'unavailable'},
		comparable: true,
		status: 'available',
		spatialUnit: 'hexagon',
	},
