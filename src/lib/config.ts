...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		...
		sat_climate_vulnerability: '?v=10',
		sat_carbon_stock: '?v=16',
		sat_pm25_drivers: '?v=13',
		sat_deforestation_dynamics: '?v=13',
		sat_productive_activity: '?v=17',
		sat_land_use: '?v=2',
		sat_soil_water: '?v=9',
		overture_scores: '?v=34',
