...
export const ANALYSIS_REGISTRY: AnalysisConfig[] = [
	...
	},
	{
		...
		coverage: { alto_parana_py: 'available', itapua_py: 'available', corrientes: 'available', chaco: 'available', formosa: 'available', parana_br: 'available', santa_catarina_br: 'unavailable', rio_grande_sul_br: 'unavailable'},
		comparable: true,
		status: 'available',
		spatialUnit: 'hexagon',
	},
