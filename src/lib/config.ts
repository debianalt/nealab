...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		...
		sat_climate_vulnerability: '?v=11',
		sat_carbon_stock: '?v=17',
		sat_pm25_drivers: '?v=14',
		sat_deforestation_dynamics: '?v=14',
		sat_productive_activity: '?v=18',
		sat_land_use: '?v=2',
		sat_soil_water: '?v=10',
		overture_scores: '?v=35',
